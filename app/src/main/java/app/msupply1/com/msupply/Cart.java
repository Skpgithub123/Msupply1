...
import static app.msupply1.com.msupply.R.id.view;


public class Cart extends AppCompatActivity implements OneClickPaymentListener {

    TextView tv_shapping_address;
    SharedPreferences sharedpreferences;
    SharedPreferences.Editor spe;
    CheckBox wallete;

    TextView tvproductamount,tvfinalafterwallete;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedpreferences = this.getSharedPreferences("msupply", Context.MODE_PRIVATE);
        String shapping_address = sharedpreferences.getString("address","hello");
        Toast.makeText(this,shapping_address,Toast.LENGTH_LONG ).show();


        tv_shapping_address = (TextView)findViewById(R.id.tv_shippingaddress);
        wallete =(CheckBox)findViewById(R.id.checkbox);
        tvfinalafterwallete =(TextView)findViewById(R.id.tvfinalafterwallete);
        tvproductamount =(TextView)findViewById(R.id.tvproductamount);

        tv_shapping_address.setText(shapping_address);
        ...
        wallete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(wallete.isChecked()){
                  tvfinalafterwallete.setVisibility(View.VISIBLE);

                }else

                  tvfinalafterwallete.setVisibility(View.GONE);
    ...
    public void Continue(View view)
    {
        ...
        userCredentials = merchantKey + ":" + "xyz@gmail.com";
        ...
        if(wallete.isChecked()){
            mPaymentParams.setAmount(tvfinalafterwallete.getText().toString());
        }else{
            mPaymentParams.setAmount(tvproductamount.getText().toString());
        }
