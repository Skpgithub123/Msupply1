...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadAttandanceFragment() {
        ...
        // If mPendingRunnable is not null, then add t loadAttandanceFragment();o the message queue
    ...
    public void onBackPressed() {
        ...
        if (shouldLoadHomeFragOnBackPress) {
            ...
            Log.d("showmehomefragment","*****  "+shouldLoadHomeFragOnBackPress);

            if (navItemIndex != 0) {
                Log.d("iamhereidex","valuresa"+navItemIndex);
                navItemIndex = 0;
                CURRENT_TAG = TAG_HOME;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_product) {
            Intent product = new Intent(this,Productmain.class);
